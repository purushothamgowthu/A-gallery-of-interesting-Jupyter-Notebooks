...
* [How to Aggregate Subscriber's Interest using the 3 methods: (1) Python Dictionary, (2) Apache PySpark - GroupBy Transformation,  and (3) Apache PySpark - ReduceBy Transformation.](https://github.com/abbas-taher/Montreal-Python-69/blob/master/Montreal%20Python%2069.ipynb).
